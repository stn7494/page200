	...
	<div class="section">
		...
		<!-- 페이징 추가 -->
					...
					<%-- <c:forEach var="ac_revinfo" items="${ac_revinfo }"> --%>
						<tr>
							...
							<td>
							<a href="/page/campingrevinfo/selectArea?cri_area_code=${ac_revinfo.cri_area_code }" data-toggle="tooltip" title="click">
								상세페이지</a>
							</td>
			...
			<div class="text-center">
				...
				<input class="btn btn-light" type="button" value="GO LIST" id="list" />
		...
		<script>
			...
			$(".btn-danger").click(function() {
				location.href = "${contextPath }/admin/campingrevinfo/remove";
			});
